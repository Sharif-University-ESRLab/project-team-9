...
const int lamp_status_request_period = 100000;  // in milliseconds
const int schedule_request_period = 15000;  // in milliseconds
const int schedule_action_period = 1000;  // in milliseconds
...
//        Serial.println(payload);  // print the text.
    ...
    if (millis_elapsed(schedule_request_period, schedule_request_last)) {
      ...
      if (httpCode > 0) {  // check the returning code
        ...
        String payload = http.getString();  // get the text from the destination
        payload = "11 2500 10 4890 11 6200 10 7400 ";  // todo: tell Ali to modify the data format
